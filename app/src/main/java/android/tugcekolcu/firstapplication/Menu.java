...
public class Menu extends ListActivity {
    ...
    String myClasses [] = {"MainActivity","ListeOrnek","TextPlay","Email","ResimCek","Tablar","Tarayici", "Flipper","SharedPreferenceScreen", "InternalData","ExternalData",
    "InsanlarDBUygulamasi"};
